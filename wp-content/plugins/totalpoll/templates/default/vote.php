    ...
    <div class="tp-buttons">
        ...
        <?php if (display_poll_buttons()): ?>
            ...
            <?php else: ?>
                ...
                <!-- button Result -->
                <button name="tp_action" value="results"
                        class="tp-btn tp-results-btn"><?php _e('Results', TP_TD); ?></button>
            <?php endif; ?>

            <!-- button Vote -->
            <button name="tp_action" value="vote"
                    class="tp-btn tp-vote-btn tp-primary-btn"><?php _e('Vote', TP_TD); ?></button>
